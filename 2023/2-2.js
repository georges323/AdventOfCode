function sumOfGameIds(gameInput) {
    ...
    for (const [id, gameData] of gameIdToData.entries()) {
        ...
        for (let data of gameData) {
            ...
            for (let cubes of cubeSplit) {
                ...
                if (cubeColor === 'red' && numberOfCubes > leastRed) {
                    leastRed = numberOfCubes;
                } else if (cubeColor === 'green' && numberOfCubes > leastGreen) {
                    leastGreen = numberOfCubes;
                } else if (cubeColor === 'blue' && numberOfCubes > leastBlue) {
                    leastBlue = numberOfCubes;
                }
            }
        }
...
console.log(sumOfGameIds(actualGameInput));